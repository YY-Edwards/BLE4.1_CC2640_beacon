...
//                     POWERCHECK_PERIOD, 0, false, POWERCHECK_EVENT);
  ...
  // Setup the GAP Peripheral Role Profile
  {
    ...
    GAPRole_SetParameter(GAPROLE_SCAN_RSP_DATA, sizeof(scanRspData),//É¨Ãè»ØÓ¦µÄÊý¾Ý
                         scanRspData);
    ...
    GAPRole_SetParameter(GAPROLE_ADVERT_DATA, sizeof(advertData), advertData);//¹ã²¥µÄÊý¾Ý
